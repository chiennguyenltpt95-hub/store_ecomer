                        ...
                        {signupPassword && (
                          <div className="mt-3">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className={`text-xs ${strength.score <= 2 ? "text-red-500" : strength.score <= 3 ? "text-amber-500" : strength.score <= 4 ? "text-blue-500" : "text-emerald-500"}`}>
                                {strength.label}
                              </span>
                            </div>
                            <div className="grid grid-cols-2 gap-1">
                              {passwordRules.map((rule) => {
                                ...
                                return (
                                  <div key={rule.label} className={`flex items-center gap-1 text-[11px] ${passed ? "text-emerald-600" : "text-muted-foreground"}`}>
                    ...
                    {resetSent ? (
                      <div className="text-center py-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-6 max-w-sm mx-auto">
                          We've sent a password reset link to <span className="text-foreground">{forgotEmail}</span>.
